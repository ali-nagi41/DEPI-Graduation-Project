...
function App() {
  ...
  const { projects, selectedProject, loading, error, fallbackMode, isMockAI } = useSelector(
  ...
  const handleCreateProject = async (e: React.FormEvent) => {
    ...
    const resultAction = await dispatch(createProject({ name: projectName, goal: projectGoal }));
