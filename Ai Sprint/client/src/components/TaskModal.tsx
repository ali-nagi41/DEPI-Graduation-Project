              ...
              {blueprint && (
                <div className="position-relative">
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-2 px-1">
                    <span className="small text-muted font-monospace d-flex align-items-center gap-1">
                      <FileCode2 size={12} />
                      AI-generated-blueprint.md
                    </span>
                    <button 
                      className="btn btn-sm btn-outline-secondary p-1 border-opacity-10 text-muted d-flex align-items-center gap-1"
                  ...
                  {/* Blueprint display */}
                  <pre className="blueprint-area text-dark small mb-0 white-space-pre-wrap">
                    <code>{blueprint}</code>
                  </pre>
                </div>
              )}
