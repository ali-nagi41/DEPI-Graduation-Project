...
export const createProject = createAsyncThunk(
  ...
  async (payload: { name: string; goal: string; teamMembers?: string }, { getState, rejectWithValue }) => {
    try {
      const state = getState() as RootState;
...
export const addTeamMember = createAsyncThunk(
  ...
  async (
    ...
    try {
      const state = getState() as RootState;
      const response = await fetch(`/api/projects/${payload.projectId}/members`, {
        method: 'PUT',
        headers: getHeaders(state),
...
export const removeTeamMember = createAsyncThunk(
  ...
  async (
    ...
    try {
      const state = getState() as RootState;
      const response = await fetch(`/api/projects/${payload.projectId}/members/${payload.username}`, {
        method: 'DELETE',
